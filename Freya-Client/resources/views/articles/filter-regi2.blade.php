    ...
    <div class="content-container">
            <div class="filters">
                ...
                <div class="category-container">
                    <span><input type="checkbox" name="deep" id="deep" {{ request('deep') == true ? 'checked' : '' }} onchange="this.form.submit()"> Keresés a cikkek szövegében is</span>
                </div>
                <div class="category-container">
                    ...
                    <input type="text" name="plant" id="plant" placeholder="Válassz növényt" list="plants" value="{{ request('plant') }}">
                ...
                <div class="category-container">
                    ...
                    <input type="date" name="before" id="before" value="{{ request('before') }}" onchange="this.form.submit()">
