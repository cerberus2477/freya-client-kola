...
@section('title', "Freya's Garden ⸙ Cikkek")
...
//         if (searchText.trim() !== "") {
//             window.location.href = "{{ route('articles.filter') }}?q=" + encodeURIComponent(
//                 searchText);
//         }
//     });
// });
...
<main>
    <div class="content-container">
        <form class="searchbar-container" method="GET" action="{{ route('articles.filter') }}">
